    ...
    return(
        <>        
            <div className="bg-slate-400 flex py-1 px-3 w-1/2 rounded-md mt-4">
                        ...
                        <button onClick={()=>{openModalHandler(idTask)}} className=" font-bold  px-2 ml-3 bg-slate-200 rounded-md text-slate-800 hover:bg-slate-600 hover:text-slate-200">Delete</button>
            </div>
        </>
    )
