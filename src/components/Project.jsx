...
export default function Project() { 
    ...
    return(
        <div className="lg:ml-36 ml-10 mt-20 lg:mt-28 lg:w-2/3">
            <MainModal>
                {/* <TaskModal/> */}
            </MainModal>
            {/* <MainModal>
            ...
            <div className="flex lg:w-2/3 mb-4">
                <h1 className="basis-2/3 font-bold text-xl lg:text-3xl text-gray-700"><u>{data[0].projectName}</u></h1>
            ...
            {data[0].tasks.length==0?<h2 className="text-center font-bold lg:text-2xl mr-10 lg:mr-0 text-xl lg:w-2/3">There's no task yet !</h2>:""}
            <ul>
                {                    
                    data[0].tasks.map(t=>
                    <div key={t.taskId}>
