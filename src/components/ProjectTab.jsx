...
export default function ProjectTab() {
    ...
    return <div className="md:hidden max-[766px]:hidden sm:hidden  lg:block lg:w-64 lg:p-4 text-center bg-slate-500">
        <h2 onClick={homePage} className="cursor-pointer text-slate-300 text-3xl font-bold mb-10"><u>HOME</u></h2>
